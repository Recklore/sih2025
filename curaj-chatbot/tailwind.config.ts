  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--chat-primary) / 0.3)",
          },
          "50%": {
            boxShadow: "0 0 30px hsl(var(--chat-primary) / 0.5)",
          },
        },
      },
      animation: {
